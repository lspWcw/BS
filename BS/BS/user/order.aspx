<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="order.aspx.cs" Inherits="BS.user.order" %>
...
<body>
    ...
    <div>
        ...
        <tr><td width="200" valign="top">
            ...
            <tr align="center"><td>编号</td><td>商品</td><td>封面</td><td>价格</td><td>数量</td><td>合计</td></tr>
            <%
            ...
            {
             %>
            <tr align="center"><td><%=list[i].id %></td><td><%=list[i].goods.title %></td><td><img src="/img/<%=list[i].goods.img %>" width="50" alt=""/></td><td><%=list[i].goods.price %></td><td><%=list[i].num %></td><td><%=list[i].num * list[i].goods.price %>元</td></tr>
            <%} %>
            </table>
